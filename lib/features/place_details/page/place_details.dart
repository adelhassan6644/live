...
class _PlaceDetailsState extends State<PlaceDetails> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => PlaceDetailsProvider(repo: sl<PlaceDetailsRepo>())..getDetails(widget.id)..checkFollowPlace(widget.id),
      child: Consumer<PlaceDetailsProvider>(builder: (context, provider2, child) {
          return Scaffold(
